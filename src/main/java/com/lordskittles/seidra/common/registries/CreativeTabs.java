...
import com.lordskittles.seidra.client.tabs.SeidraMainTab;
...
public class CreativeTabs
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN = TABS.register("main", SeidraMainTab::new);
