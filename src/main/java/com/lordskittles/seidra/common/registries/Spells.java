...
import com.lordskittles.seidra.common.sai.spells.TestSpell;

public class Spells
{
	public static final SeidraRegistries.Spells SPELLS = SeidraRegistries.createSpells(Seidra.MODID);

	public static final DeferredSpell<TestSpell> TEST_SPELL = SPELLS.register("test_spell", TestSpell::new);
}
