...
public class SeidraGem extends SeidraItem
{
	public SeidraGem(String prettyName)
	{
	...
	public ItemModelBuilder modelBuilder(ItemModelProvider modelProvider, ResourceLocation key)
	{
		return modelProvider.withExistingParent(
				...
				"layer0", ResourceLocation.fromNamespaceAndPath(Seidra.MODID, "item/gems/" + key.getPath())
		);
	}
