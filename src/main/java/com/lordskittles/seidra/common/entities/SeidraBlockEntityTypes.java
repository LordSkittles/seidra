...
public class SeidraBlockEntityTypes
{
    ...
    public static final Supplier<BlockEntityType<SindriWorkbenchBlockEntity>> SINDRI_WORKBENCH_BE = BLOCK_ENTITY_TYPES.register(
            Constants.buildName(Constants.Types.SINDRI, Constants.Groups.BLOCK, Constants.Groups.ENTITY),
