    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(SeidraBlocks.BISMUTH_ORE.get(),
                        ...
                        SeidraBlocks.FELDSPAR_STAIRS.get(),
                        SeidraBlocks.FELDSPAR_BRICK_STAIRS.get(),
                        SeidraBlocks.POLISHED_FELDSPAR_STAIRS.get(),
                        SeidraBlocks.FELDSPAR_SLAB.get(),
                        SeidraBlocks.FELDSPAR_BRICK_SLAB.get(),
                        SeidraBlocks.POLISHED_FELDSPAR_SLAB.get(),
                        SeidraBlocks.FELDSPAR_BUTTON.get(),
                        SeidraBlocks.FELDSPAR_PRESSURE_PLATE.get()
                );
        ...
        tag(BlockTags.SLABS).add(
                SeidraBlocks.ASH_SLAB.get(),
                SeidraBlocks.PINE_SLAB.get(),
                SeidraBlocks.YEW_SLAB.get(),
                SeidraBlocks.FELDSPAR_SLAB.get(),
                SeidraBlocks.FELDSPAR_BRICK_SLAB.get(),
                SeidraBlocks.POLISHED_FELDSPAR_SLAB.get()
        );
        ...
        tag(BlockTags.STAIRS).add(
                SeidraBlocks.ASH_STAIRS.get(),
                SeidraBlocks.PINE_STAIRS.get(),
                SeidraBlocks.YEW_STAIRS.get(),
                SeidraBlocks.FELDSPAR_STAIRS.get(),
                SeidraBlocks.FELDSPAR_BRICK_STAIRS.get(),
                SeidraBlocks.POLISHED_FELDSPAR_STAIRS.get()
        );
